...
const I18N = {
  ja: {
    ...
    pegFair:        '適正',
    pegExpensive:   '割高',
    roeTitle:       '💰 ROE（自己資本利益率）',
    roeDesc:        '当期純利益 ÷ 自己資本。目安: 15%以上=優良、8%以上=標準、8%未満=資本効率に課題。',
    roeExcellent:   '優良',
    roeAverage:     '標準',
    roeLow:         '課題あり',
    roeNegative:    '赤字',
  ...
  en: {
    ...
    roeTitle:       '💰 ROE (Return on Equity)',
    roeDesc:        'Net income ÷ shareholder equity. Rule of thumb: 15%+ excellent, 8%+ average, below 8% weak capital efficiency.',
    roeExcellent:   'Excellent',
    roeAverage:     'Average',
    roeLow:         'Weak',
    roeNegative:    'Negative',
